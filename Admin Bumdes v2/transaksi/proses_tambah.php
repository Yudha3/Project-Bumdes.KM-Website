...
$query2 = mysqli_query($koneksi,"insert into data_klr (id_transaksi,tgl_keluar,id_brg,barang,jml_keluar,total_hrg,penerima,keterangan) values('$id_transaksi','$tgl_keluar','$kode_barang','$nama_barang','$jml_keluar','$total','$penerima','$keterangan')");
