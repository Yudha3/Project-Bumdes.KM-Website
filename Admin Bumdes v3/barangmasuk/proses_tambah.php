...
$query2 = mysqli_query($koneksi, "insert into data_msk (id_transaksi,tgl_msk,id_brg,barang,pengirim,hg_beli,jml_masuk,total_hrg) values('$id_transaksi','$tgl_msk','$kode_barang','$nama_barang','$nama_mitra','$hg_beli','$jml_masuk','$total')");
