                ...
                <div class="projects">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <button><a href="newReseller.php">New Reseller</a> <span class="las la-arrow-right">
                                </span></button>
                        </div>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="editReseller.php?id=<?php echo $row['id']; ?>">Edit</a> |
                                                    <a href="proses_hapusreseller.php?id=<?php echo $row['id']; ?>" onclick="return confirm('Anda yakin akan menghapus data ini?')">Hapus</a>
                                                </td>
                                            </tr>
